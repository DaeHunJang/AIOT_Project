...
int main(int argc, char *argv[])
{
	...
	CLIENT_INFO client_info[MAX_CLNT] = {	{0,-1,"","HM_CON","PASSWD"}, 	{0,-1,"","1","PASSWD"}, \
											...
											{0,-1,"","PJ_BOT1","PASSWD"},   {0,-1,"","PJ_BOT2","PASSWD"}, \
											{0,-1,"","PJ_QT","PASSWD"},  	{0,-1,"","PJ_JN","PASSWD"}, \
											{0,-1,"","PJ_RFID0","PASSWD"},	{0,-1,"","PJ_RFID1","PASSWD"}, \
											{0,-1,"","PJ_RFID2","PASSWD"},  {0,-1,"","PJ_DOOR","PASSWD"}, \
											{0,-1,"","PJ_CARD1","PASSWD"},  {0,-1,"","PJ_CARD2","PASSWD"}, \
											{0,-1,"","PJ_CARD3","PASSWD"},  {0,-1,"","PJ_AP","PASSWD"}, \
											{0,-1,"","PJ_SQL","PASSWD"}, 	{0,-1,"","PJ_BT","PASSWD"}, \
											{0,-1,"","PJ_STM32","PASSWD"}, 	{0,-1,"","PJ_LIN","PASSWD"}, \
											{0,-1,"","PJ_AND","PASSWD"},  	{0,-1,"","PJ_ARD","PASSWD"} };
	...
	while(1 /* true */) 
	{
		...
		else  { shutdown(clnt_sock, SHUT_WR); }
	}
	return 0;
}
